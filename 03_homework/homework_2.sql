...
Select customer_last_name, customer_first_name, customer_id, customer_zip
FROM customer
Limit 10;
...
SELECT customer_purchases.*, (customer_purchases.quantity * customer_purchases.cost_to_customer_per_qty) AS price
FROM customer_purchases
